...
def main():
    ...
    #
    # t_stat, p_value = stats.ttest_ind(bigram, unigram_bigram);
    # print("Bi, Uni-Bi", p_value/2, t_test_accept(p_value))
    #
    # t_stat, p_value = stats.ttest_ind(bigram, unigram);
    # print("Bi, Uni", p_value/2, t_test_accept(p_value))
    ...
    #     #x.pop()
    # for company in companies_2:
    #     with open('../Price Prediction/SVM-Sent Data/Progress/{0}.csv'.format(company.replace("_2", "")), 'w+') as file:
