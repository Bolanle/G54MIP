...
if __name__ == '__main__':
    companies_keywords = ['Goldman', 'Sachs', 'Coca', 'Coca-cola', 'JP', 'Morgan', 'Microsoft', 'Walt', 'Disney', 'Chevron', 'Exxon', 'Mobile', 'Pfizer', 'Visa', 'Visa Inc', 'IBM', 'Procter', 'Gamble', 'General', 'Electric', 'AT&T']
    root = Element("news")
    archive_base_url = "http://bloomberg.com/archive/news/"
    news_base_url = "http://bloomberg.com/news/"
    current_year = 2013
    current_month = 11
    last_day = datetime.date(2013, 11, 1)
